                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <?php
                                ...
                                if (isset($_GET['id'])) {
                                    $idBolsa = secure_data($_GET['id']);

                                    // Verificar si la bolsa está asociada a la tabla codigobarras
                                    $consultaVerificarCodigobarras = "SELECT * FROM codigobarras WHERE idBolsa = :idBolsa";
                                    $stmtVerificarCodigobarras = $connectDB->prepare($consultaVerificarCodigobarras);
                                    $stmtVerificarCodigobarras->bindValue(':idBolsa', $idBolsa);
                                    $stmtVerificarCodigobarras->execute();

                                    // Si existen registros asociados en la tabla codigobarras, mostrar error
                                    if ($stmtVerificarCodigobarras->rowCount() > 0) {
                                        echo "<script>
                                                Swal.fire({
                                                    icon: 'error',
                                                    title: 'Error al borrar',
                                                    text: 'La Bolsa está asociada a la tabla Codigobarras. No se puede eliminar.',
                                        ...
                                        $stmtBorrarBolsa = $connectDB->prepare('DELETE FROM bolsa WHERE idBolsa = :idBolsa');
                                        $stmtBorrarBolsa->bindValue(':idBolsa', $idBolsa);
                                        $stmtBorrarBolsa->execute();
                                    ...
                                    echo "<script>
                                            Swal.fire({
                                                icon: 'error',
                                                title: 'Error al borrar',
                                                text: 'Hubo un problema al intentar borrar la Bolsa',
                                                showConfirmButton: false,
                                                timer: 1500
                                            }).then(function() {
                                                window.location.href = 'indexBolsa.php';
