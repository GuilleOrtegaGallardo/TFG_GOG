                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['Enviar'])) {
                                    ...
                                    if (empty($idProceso) || empty($idProducto) || empty($cantidad)) {
                                        ...
                                        // Validar que la cantidad sea un número decimal y no supere 1
                                        if (!preg_match('/^\d+(\.\d+)?$/', $cantidad) || $cantidad > 1) {
                                            echo "<script>
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: 'Error de validación',
                                                        text: 'La cantidad debe ser un número decimal que no supere 1',
                                                        showConfirmButton: false,
                                                        timer: 1500
                                                    });
                                                </script>";
                                            ...
                                            $sql = 'UPDATE bolsa SET 
                                                    idProceso = COALESCE(:idProceso, idProceso),
                                ...
                                $stmt = $connectDB->prepare('SELECT * FROM bolsa WHERE idBolsa = :idBolsa');
                                $stmt->bindParam(':idBolsa', $idBolsa);
                                $stmt->execute();
                                $bolsaActual = $stmt->fetch(PDO::FETCH_ASSOC);

                                if (!$bolsaActual) {
                                    echo "Bolsa no encontrada.";
                                    exit();
                                }
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tr>
                                        <td><?php echo $bolsaActual['idBolsa']; ?></td>
                                        <td><?php echo $bolsaActual['idProceso']; ?></td>
                                        <td><?php echo $bolsaActual['idProducto']; ?></td>
                                        <td><?php echo $bolsaActual['cantidad']; ?></td>

                                        <td>
                                            <?php
                                            echo '<a href="editarBolsa.php?id=' . $bolsaActual['idBolsa'] . '">';
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteBolsa.php?id=' . $bolsaActual['idBolsa'] . '">';
                        ...
                        <div class="card mb-4">
                            ...
                            <h2>Formulario de Edición de Bolsa</h2>

                                    <form action="" method="get">

                                        <div class="mb-3">
                                            <label for="idBolsa" class="form-label">ID BOLSA</label>
                                            <input class="form-control col-4" type="text" name="id" value="<?php echo $bolsaActual['idBolsa']; ?>" readonly>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control col-4" type="text" id="cantidad" name="cantidad" value="<?php echo $bolsaActual['cantidad']; ?>">
                                        </div>

                                        

                                        <input type="submit" class="btn btn-success" name="Enviar" value="Actualizar">
                                        <a href="indexBolsa.php"><button class="btn btn-primary" type="button">Volver</button></a>
