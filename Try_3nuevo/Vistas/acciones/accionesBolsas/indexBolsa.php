...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM bolsa');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br/>
                                <br>
                                <a name="" id="" class="btn btn-success" href="nuevaBolsa.php" role="button">Agregar Registro</a> | <a  name="" id="" class="btn btn-success" href="buscarBolsa.php" role="button">Busqueda detallada</a>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php  echo $registro['idBolsa']; ?> </td>
                                        ...
                                        <td>
                                        <?php
                                        echo '<a href="editarBolsa.php?id='.$registro['idBolsa'].'">' ;
                                        echo '<i class="fa-solid fa-pen-to-square"></i>';
                                        echo '</a>';
                                        echo ' | ';
                                        echo '<a href="deleteBolsa.php?id='.$registro['idBolsa'].'">' ;
