...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM deposito');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br/>
                                <br>
                                <a name="" id="" class="btn btn-success" href="nuevoDeposito.php" role="button">Agregar Registro</a> | <a  name="" id="" class="btn btn-success" href="buscarDeposito.php" role="button">Busqueda detallada</a>
                                <br>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php  foreach($allData as $registro) {  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php  echo $registro['idDeposito']; ?> </td>
                                            <td><?php  echo $registro['descripcion']; ?> </td>
                                            <td><?php  echo $registro['limiteOcupacion']; ?> </td>
                                            <td><?php  echo $registro['cantidadOcupada']; ?> </td>
                                            <td><?php  echo $registro['porcentajeOcupacion']; ?> </td>
                                            <td><?php  echo $registro['ubicacion']; ?> </td>

                                            
                                            <td>
                                            <?php
                                            echo '<a href="editarDeposito.php?id='.$registro['idDeposito'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteDeposito.php?id='.$registro['idDeposito'].'">' ;
