                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            if (!empty($idLineaProduccion) || !empty($nombre) || !empty($abreviatura) || !empty($descripcion) || !empty($ubicacion)) {

                                // Construir la consulta SQL base
                                $sql = 'SELECT * FROM lineaproduccion WHERE 1=1';
                                ...
                                if (!empty($resultados)) {
                                    ...
                                    foreach ($resultados as $fila) {
                                        echo '<tr>
                                                ...
                                                <td>
                                                    <a name="editar" id=""  href="editarLinea.php?id=' . $fila['idLineaProduccion'] . '"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a name="eliminar" id=""  href="deleteLinea.php?id=' . $fila['idLineaProduccion'] . '"><i class="fa-solid fa-trash"></i></a>
                                                </td>
                                            </tr>';
                                    }
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="buscarLinea.php" method="post" enctype="multipart/form-data">

                                <div class="mb-3">
                                    <label for="idLineaProduccion" class="form-label">ID LINEA PRODUCCION</label>
                                    <input type="text" class="form-control" name="idLineaProduccion" id="idLineaProduccion" aria-describedby="helpId" placeholder="ID LINEA PRODUCCION">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="ubicacion" id="ubicacion" aria-describedby="helpId" placeholder="UBICACION">
                                </div>

                                <button type="submit" class="btn btn-success">Realizar Búsqueda</button>
                                <a name="" id="" class="btn btn-primary" href="indexLinea.php" role="button">Cancelar</a>
