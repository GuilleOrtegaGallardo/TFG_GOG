...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM lineaproduccion');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                TABLA LIENA PRODUCCION
                                <br>
                                <br/>
                                <a name="" id="" class="btn btn-success" href="nuevaLinea.php" role="button">Agregar Registro</a>  | <a  name="" id="" class="btn btn-success" href="buscarLinea.php" role="button">Busqueda detallada</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php  foreach($allData as $registro) {  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php
                                            echo '<a href="editarLinea.php?id='.$registro['idLineaProduccion'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteLinea.php?id='.$registro['idLineaProduccion'].'">' ;
