...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM proceso');
    $stmt->execute();
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <br/>
                        <a name="" id="" class="btn btn-success" href="nuevoProceso.php" role="button">Agregar Registro</a> | <a style="margin-top: 5px !important;" name="" id="" class="btn btn-success" href="buscarProceso.php" role="button">Busqueda detallada</a>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php  foreach($allData as $registro) {  ?>

                                        <tr>

                                            <td><?php  echo $registro['idProceso']; ?> </td>
                                            <td><?php  echo $registro['idProducto']; ?> </td>
                                            <td><?php  echo $registro['idReactor']; ?> </td>
                                            <td><?php  echo $registro['idUsuario']; ?> </td>
                                            <td><?php  echo $registro['idLineaProduccion']; ?> </td>
                                            <td><?php  echo $registro['fechaProceso']; ?> </td>
                                            <td><?php  echo $registro['horaInicio']; ?> </td>
                                            <td><?php  echo $registro['horaFin']; ?> </td>
                                            <td><?php  echo $registro['temperaturaMax']; ?> </td>
                                            <td><?php  echo $registro['temperaturaMin']; ?> </td>
                                            

                                            
                                            <td>
                                            <?php
                                            echo '<a href="editarProceso.php?id='.$registro['idProceso'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteProceso.php?id='.$registro['idProceso'].'">' ;
