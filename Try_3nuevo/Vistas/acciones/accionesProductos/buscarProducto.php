            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container-fluid px-4">
                        <h4 class="mt-4">Buscar producto</h4>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    if (!empty($idProducto) || !empty($nombre) || !empty($descripcion) || !empty($abreviatura)) {
                                        ...
                                        if (!empty($resultados)) {
                                            ...
                                            foreach ($resultados as $fila) {
                                                echo '<tr>
                                                        ...
                                                        <td>
                                                            <a name="editar" id=""  href="editarProducto.php?id=' . $fila['idProducto'] . '"><i class="fa-solid fa-pen-to-square"></i></a>
                                                            <a name="eliminar" id=""  href="deleteProducto.php?id=' . $fila['idProducto'] . '"><i class="fa-solid fa-trash"></i></a>
                                                        </td>
                                                    </tr>';
                                            }
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="buscarProducto.php" method="post" enctype="multipart/form-data">
