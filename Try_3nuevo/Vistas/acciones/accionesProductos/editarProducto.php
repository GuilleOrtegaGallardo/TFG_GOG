                            ...
                            <?php 
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['Enviar'])) {
                                    ...
                                    if (empty($idDeposito) || empty($nombre) || empty($descripcion) || empty($abreviatura)) {
                                        ...
                                        // Validar expresión regular para abreviatura
                                        $formatoAbreviatura = '/^D\d+$/';
                                        if (!preg_match($formatoAbreviatura, $abreviatura)) {
                                            echo "<script>
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: 'Error de validación',
                                                        text: 'La abreviatura debe ser D seguida de un número (Ej. D1, D2, D3, ...)',
                                                        showConfirmButton: false,
                                                        timer: 1500
                                                    });
                                                </script>";
                                            ...
                                            $sql = 'UPDATE producto SET 
                                                    idDeposito = COALESCE(:idDeposito, idDeposito),
                                ...
                                $stmt = $connectDB->prepare('SELECT * FROM producto WHERE idProducto = :idProducto');
                                $stmt->bindParam(':idProducto', $idProducto);
                                $stmt->execute();
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tr>
                                        <td><?php echo $productoActual['idProducto']; ?></td>
                                        <td><?php echo $productoActual['idDeposito']; ?></td>
                                        <td><?php echo $productoActual['nombre']; ?></td>
                                        <td><?php echo $productoActual['descripcion']; ?></td>
                                        <td><?php echo $productoActual['abreviatura']; ?></td>

                                        <td>
                                            <?php
                                            echo '<a href="editarProducto.php?id=' . $productoActual['idProducto'] . '">';
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteProducto.php?id=' . $productoActual['idProducto'] . '">';
                            ...
                            <h2>Formulario de Edición de Producto</h2>
                                ...
                                <form action="" method="get">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control col-4" type="text" name="id" value="<?php echo $productoActual['idProducto']; ?>" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control col-4" type="text" id="nombre" name="nombre" value="<?php echo $productoActual['nombre']; ?>" >
                                    </div>

                                    <div class="mb-3">
                                        <label for="descripcion">Descripción:</label>
                                        <input class="form-control col-4" type="text" id="descripcion" name="descripcion" value="<?php echo $productoActual['descripcion']; ?>">
                                    </div>

                                    <div class="mb-3">
                                        <label for="abreviatura">Abreviatura:</label>
                                        <input class="form-control col-4" type="text" id="abreviatura" name="abreviatura" value="<?php echo $productoActual['abreviatura']; ?>">
                                    </div>

                                   

                                    <input type="submit" class="btn btn-success" name="Enviar" value="Actualizar">
                                    <a href="indexProducto.php"><button class="btn btn-primary" type="button">Volver</button></a>
