...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM producto');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br/>
                                <br>
                                <a name="" id="" class="btn btn-success" href="nuevoProducto.php" role="button">Agregar Registro</a> | <a style="margin-top: 5px !important;" name="" id="" class="btn btn-success" href="buscarProducto.php" role="button">Busqueda detallada</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php  foreach($allData as $registro) {  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php
                                            echo '<a href="editarProducto.php?id='.$registro['idProducto'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteProducto.php?id='.$registro['idProducto'].'">' ;
