            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container-fluid px-4">
                        <h4 class="mt-4">Buscar Proveedor</h4>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    if (!empty($idProveedor) || !empty($idLocalidad) || !empty($CIF) || !empty($nombre) || !empty($calle) || !empty($CP) || !empty($tlfContacto) ||
                                        !empty($email) || !empty($cuentaBancaria)) {
                                        ...
                                        if (!empty($tlfContacto)) {
                                            $sql .= ' AND tlfContacto = :tlfContacto';
                                        }
                                        ...
                                        if (!empty($cuentaBancaria)) {
                                            $sql .= ' AND cuentaBancaria = :cuentaBancaria';
                                        }
                                        ...
                                        if (!empty($resultados)) {
                                            ...
                                            foreach ($resultados as $fila) {
                                                echo '<tr>
                                                        ...
                                                        <td>' . $fila['calle'] . '</td>
                                                        <td>' . $fila['CP'] . '</td>
                                                        <td>' . $fila['tlfContacto'] . '</td>
                                                        <td>' . $fila['email'] . '</td>
                                                        <td>' . $fila['cuentaBancaria'] . '</td>
                                                        <td>
                                                            <a name="editar" id=""  href="editarProveedor.php?id=' . $fila['idProveedor'] . '"><i class="fa-solid fa-pen-to-square"></i></a>
                                                            <a name="eliminar" id=""  href="deleteProveedor.php?id=' . $fila['idProveedor'] . '"><i class="fa-solid fa-trash"></i></a>
                                                        </td>
                                                    </tr>';
                                            }
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="buscarProveedor.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="idLocalidad" class="form-label">ID LOCALIDADAD</label>
                                    <input type="text" class="form-control" name="idLocalidad" id="idLocalidad" aria-describedby="helpId" placeholder="ID LOCALIDAD">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="calle" id="calle" aria-describedby="helpId" placeholder="CALLE">
                                </div>

                                <div class="mb-3">
                                    <label for="CP" class="form-label">CP</label>
                                    <input type="text" class="form-control" name="CP" id="CP" aria-describedby="helpId" placeholder="CP">
                                </div>

                                <div class="mb-3">
                                    <label for="telefonoContacto" class="form-label">TLFCONTACTO</label>
                                    <input type="text" class="form-control" name="telefonoContacto" id="telefonoContacto" aria-describedby="helpId" placeholder="TELEFONO DE CONTACTO">
                                </div>
