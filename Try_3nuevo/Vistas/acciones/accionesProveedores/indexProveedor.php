...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM proveedor');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br>
                                <br/>
                                <a name="" id="" class="btn btn-success" href="nuevoProveedor.php" role="button">Agregar Registro</a> | <a  name="" id="" class="btn btn-success" href="buscarProveedor.php" role="button">Busqueda detallada</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php  foreach($allData as $registro) {  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $registro['idLocalidad']; ?> </td>
                                            <td><?php  echo $registro['CIF']; ?> </td>
                                            <td><?php  echo $registro['nombre']; ?> </td>
                                            
                                            <td><?php  echo $registro['calle']; ?> </td>
                                            <td><?php  echo $registro['CP']; ?> </td>
                                            <td><?php  echo $registro['tlfContacto']; ?> </td>
                                            <td><?php  echo $registro['email']; ?> </td>
                                            <td><?php  echo $registro['cuentaBancaria']; ?> </td>

                                            
                                            <td>
                                            <?php
                                            echo '<a href="editarProveedor.php?id='.$registro['idProveedor'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteProveedor.php?id='.$registro['idProveedor'].'">' ;
