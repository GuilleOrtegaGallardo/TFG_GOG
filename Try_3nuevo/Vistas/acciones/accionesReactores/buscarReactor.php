            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container-fluid px-4">
                        <h4 class="mt-4">Buscar reactor</h4>
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    */
                                    ...
                                    if (!empty($idReactor) || !empty($nombre) || !empty($abreviatura) || !empty($descripcion) ||
                                        !empty($fechaInstalacion) || !empty($fechaMantenimiento)) {

                                        // Construir la consulta SQL base
                                        $sql = 'SELECT * FROM reactor WHERE 1=1';
                                        ...
                                        if (!empty($abreviatura)) {
                                            $sql .= ' AND abreviatura = :abreviatura';
                                        }
                                        ...
                                        if (!empty($fechaInstalacion)) {
                                            $sql .= ' AND fechaInstalacion = :fechaInstalacion';
                                        }

                                        if (!empty($fechaMantenimiento)) {
                                            $sql .= ' AND fechaMantenimiento = :fechaMantenimiento';
                                        }
                                        ...
                                        if (!empty($resultados)) {
                                            ...
                                            foreach ($resultados as $fila) {
                                                echo '<tr>
                                                        ...
                                                        <td>
                                                            <a name="editar" id=""  href="editarReactor.php?id=' . $fila['idReactor'] . '"><i class="fa-solid fa-pen-to-square"></i></a>
                                                            <a name="eliminar" id=""  href="deleteReactor.php?id=' . $fila['idReactor'] . '"><i class="fa-solid fa-trash"></i></a>
                                                        </td>
                                                    </tr>';
                                            }
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="buscarReactor.php" method="post" enctype="multipart/form-data">

                                    <div class="mb-3">
                                    <label for="idReactor" class="form-label">ID REACTOR</label>
                                    <input type="text"
                                        class="form-control" name="idReactor" id="idReactor" aria-describedby="helpId" placeholder="ID REACTOR">
                                    </div>
                                    ...
                                    <input type="text"
                                        class="form-control" name="abreviatura" id="abreviatura" aria-describedby="helpId" placeholder="ABREVIATURA">
                                    </div>
                                    ...
                                    <input type="date"
                                        class="form-control" name="fechaInstalacion" id="fechaInstalacion" aria-describedby="helpId" placeholder="">
                                    </div>
                                    ...
                                    <input type="date"
                                        class="form-control" name="fechaMantenimiento" id="fechaMantenimiento" aria-describedby="helpId" placeholder="?">
                                    </div>
