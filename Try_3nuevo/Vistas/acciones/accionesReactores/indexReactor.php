...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM reactor');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br>
                                <br>
                                <a  name="" id="" class="btn btn-success" href="nuevoReactor.php" role="button">Agregar Registro</a> | <a  name="" id="" class="btn btn-success" href="buscarReactor.php" role="button">Busqueda detallada</a>
                                <br>
                                <br>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php  echo $registro['abreviatura']; ?> </td>
                                                <td><?php  echo $registro['descripcion']; ?> </td>
                                                <td><?php  echo $registro['fechaInstalacion']; ?> </td>
                                                <td><?php  echo $registro['fechaMantenimiento']; ?> </td>
                                                
                                                
                                                <td>
                                                <?php
                                                echo '<a href="editarReactor.php?id='.$registro['idReactor'].'">' ;
                                                echo '<i class="fa-solid fa-pen-to-square"></i>';
                                                echo '</a>';
                                                echo ' | ';
                                                echo '<a href="deleteReactor.php?id='.$registro['idReactor'].'">' ;
