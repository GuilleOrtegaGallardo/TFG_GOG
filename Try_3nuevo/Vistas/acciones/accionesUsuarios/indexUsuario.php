...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM usuarios');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br>
                                <br>
                                <a  name="" id="" class="btn btn-success" href="nuevoUsuario.php" role="button">Agregar Registro</a> | <a  name="" id="" class="btn btn-success" href="buscarUsuario.php" role="button">Busqueda detallada</a>
                                <br>
                                <br>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo $registro['idUsuario']; ?> </td>
                                            ...
                                            <td>
                                            <?php
                                            echo '<a href="editarUsuario.php?id='.$registro['idUsuario'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deleteUsuario.php?id='.$registro['idUsuario'].'">' ;
