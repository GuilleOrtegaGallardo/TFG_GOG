...
<!-- <script type="text/javascript">
    $(function(){
        $('#register').click(function(e){
            ...
            if(valid){
                var idCodigoBarras = $('#idCodigoBarras').val();
                var codigoBarras = $('#codigoBarras').val();
                var nombre = $('#nombre').val();
                var idBolsa = $('#idBolsa').val();

                $.ajax({
                    type: 'POST',
                    url: '../includes/insertar.php',
                    data: { codigoBarras: codigoBarras, nombre: nombre, idBolsa: idBolsa, idCodigoBarras: idCodigoBarras },
                    ...
                    error: function(xhr, textStatus, errorThrown){
                        Swal.fire({
                            title: 'Error',
                            text: xhr.responseText || 'Error al procesar la solicitud',
                            icon: 'error'
                        });
                    }
                });
