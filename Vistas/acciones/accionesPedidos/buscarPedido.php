            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container-fluid px-4">
                        <h4 class="mt-4">Buscar pedido</h4>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    // Verificar si se ha enviado el formulario (solicitud POST)
                                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                        ...
                                        $servido = $_POST['servido'] ?? '';

                                        // Verificar si al menos un campo del formulario ha sido llenado
                                        if (!empty($idPedido) || !empty($idProveedor) || !empty($idProducto) || !empty($idUsuario) ||
                                            !empty($cantidad) || !empty($precioProducto) || !empty($fechaPedido) || isset($servido)) {
                                            ...
                                            if (!empty($precioProducto)) {
                                                $sql .= ' AND precioProducto = :precioProducto';
                                            }

                                            if (!empty($fechaPedido)) {
                                                $sql .= ' AND fechaPedido = :fechaPedido';
                                            }

                                            // Modificar la condición para incluir registros con servido = 0 o 1
                                            if (isset($servido)) {
                                                $sql .= ' AND servido = :servido';
                                            }
                                            ...
                                            // Bindear el parámetro de servido solo si está definido
                                            if (isset($servido)) {
                                            ...
                                            if (!empty($resultados)) {
                                                ...
                                                foreach ($resultados as $fila) {
                                                    echo '<tr>
                                                            ...
                                                            <td>' . $fila['servido'] . '</td>
                                                            <td>
                                                                <a name="editar" id=""  href="editarPedido.php?id=' . $fila['idPedido'] . '"><i class="fa-solid fa-pen-to-square"></i></a>
                                                                <a name="eliminar" id=""  href="deletePedido.php?id=' . $fila['idPedido'] . '"><i class="fa-solid fa-trash"></i></a>
                                                            </td>
                                                        </tr>';
                                                }
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="buscarPedido.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="cantidad" id="cantidad" aria-describedby="helpId" placeholder="CANTIDAD">
                                    </div>

                                    <div class="mb-3">
                                        <label for="precioProducto" class="form-label">PRECIO PRODUCTO</label>
                                        <input type="number" class="form-control" name="precioProducto" id="precioProducto" aria-describedby="helpId" placeholder="PRECIO PRODUCTO">
                                    </div>

                                    <div class="mb-3">
                                        <label for="fechaPedido" class="form-label">FECHA PEDIDO</label>
                                        <input type="date" class="form-control" name="fechaPedido" id="fechaPedido" aria-describedby="helpId" placeholder="FECHA PEDIDO">
                                    </div>

                                    <div class="mb-3">
                                        <label for="servido" class="form-label">SERVIDO</label>
                                        <select class="form-select" name="servido" id="servido">
