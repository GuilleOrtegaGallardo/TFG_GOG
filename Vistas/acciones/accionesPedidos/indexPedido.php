...
require_once('../../../Controlador/Conexion_DB/config.php');
    ...
    $singleDataById = '';
    //Para listar todos 
    $stmt = $connectDB->prepare('SELECT * FROM pedido');
    $stmt->execute();
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br/>
                                <br>
                                <a name="" id="" class="btn btn-success" href="nuevoPedido.php" role="button">Agregar Registro</a> | <a  name="" id="" class="btn btn-success" href="buscarPedido.php" role="button">Busqueda detallada</a>
                                <br>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php  foreach($allData as $registro) {  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php  echo $registro['servido']; ?> </td>
                                            ...
                                            <td>
                                            <?php
                                            echo '<a href="editarPedido.php?id='.$registro['idPedido'].'">' ;
                                            echo '<i class="fa-solid fa-pen-to-square"></i>';
                                            echo '</a>';
                                            echo ' | ';
                                            echo '<a href="deletePedido.php?id='.$registro['idPedido'].'">' ;
